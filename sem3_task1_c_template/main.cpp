...
public:
    ...
    void parseText(std::vector<size_t> &tempPositions, const std::string &text);
...
void StringTemplate::parseText(std::vector<size_t> &positions, const std::string &text) {
    auto currNode = root;
...
int main() {
    ...
    std::vector<size_t> tempPositions;
    parser.parseText(tempPositions, text);
